...
;(async () => {
  ...
  const diag = await page.evaluate(() => {
    ...
    return {
      ...
      scene: sceneBox
        ? { top: sceneBox.top, left: sceneBox.left, width: sceneBox.width, height: sceneBox.height }
        : null,
      world: worldBox
        ? { top: worldBox.top, left: worldBox.left, width: worldBox.width, height: worldBox.height }
        : null,
